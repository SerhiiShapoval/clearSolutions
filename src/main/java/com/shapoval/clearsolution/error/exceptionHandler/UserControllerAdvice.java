...
public class UserControllerAdvice {
    ...
    public ResponseEntity<UserErrorResponse> handleUserWrongBirthDateException(UserWrongDateException exception
            , HttpServletRequest request){

        return  ResponseEntity.badRequest().body(UserErrorResponse.builder()
    ...
    public ResponseEntity<UserErrorResponse> handleUserNotFoundException(UserNotFoundException exception
        ...
        return  ResponseEntity.status(HttpStatus.NOT_FOUND).body(UserErrorResponse.builder()
    ...
    public ResponseEntity<UserErrorResponse> handleIllegalArgumentException(IllegalArgumentException exception
        ...
        return  ResponseEntity.badRequest().body(UserErrorResponse.builder()
                .error(ErrorTitle.USER_INCORRECT_DATA.getError())
                .detail(exception.getMessage())
                .path(request.getRequestURI())
                .timestamp(LocalDateTime.now())
                .build());
    ...
    public ResponseEntity<UserErrorResponse> handleUserWrongAgeException(UserWrongAgeException exception
        ...
        return   ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(UserErrorResponse.builder()
    ...
    public ResponseEntity<UserErrorResponse> handleUserEmailExistException(UserEmailExistException exception
        ...
        return  ResponseEntity.status(HttpStatus.CONFLICT).body(UserErrorResponse.builder()
